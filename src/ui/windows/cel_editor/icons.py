...
# Global Material Icons Repository Path
...
class CelEditorIcons:
    ...
    def new_file(self) -> QIcon:
        return self.loader.get_icon('file', 'note_add')

    @property
    def open_file(self) -> QIcon:
        return self.loader.get_icon('file', 'folder_open')

    @property
    def save(self) -> QIcon:
        return self.loader.get_icon('content', 'save')

    @property
    def undo(self) -> QIcon:
        return self.loader.get_icon('content', 'undo')

    @property
    def redo(self) -> QIcon:
        return self.loader.get_icon('content', 'redo')

    # View mode icons
    @property
    def view_pattern(self) -> QIcon:
        return self.loader.get_icon('action', 'view_module')

    @property
    def view_code(self) -> QIcon:
        return self.loader.get_icon('action', 'code')

    @property
    def view_chart(self) -> QIcon:
        return self.loader.get_icon('editor', 'show_chart')

    @property
    def view_split(self) -> QIcon:
        return self.loader.get_icon('action', 'view_agenda')

    # Pattern Builder icons
    @property
    def add_candle(self) -> QIcon:
        return self.loader.get_icon('content', 'add')

    @property
    def delete_candle(self) -> QIcon:
        return self.loader.get_icon('action', 'delete')

    @property
    def clear_all(self) -> QIcon:
        return self.loader.get_icon('content', 'clear')

    @property
    def zoom_in(self) -> QIcon:
        return self.loader.get_icon('action', 'zoom_in')

    @property
    def zoom_out(self) -> QIcon:
        return self.loader.get_icon('action', 'zoom_out')

    @property
    def zoom_fit(self) -> QIcon:
        return self.loader.get_icon('action', 'zoom_out_map')

    # AI Assistant icons
    @property
    def ai_generate(self) -> QIcon:
        return self.loader.get_icon('action', 'auto_awesome')

    @property
    def ai_suggest(self) -> QIcon:
        return self.loader.get_icon('action', 'tips_and_updates')

    # Settings icons
    @property
    def settings(self) -> QIcon:
        return self.loader.get_icon('action', 'settings')

    @property
    def help(self) -> QIcon:
        return self.loader.get_icon('action', 'help')
